function output = MBMF_stochastic_1choice_p_sim(x,P)

% Mixed model-based / model-free simulation code for a task with stochastic
% transitions, one choice at the second level, and reward probabilities 
% for the second-level bandits
%
% USAGE: output = MBMF_stochastic_1choice_p_sim(x,rews)
%
% INPUTS:
...
%       in second-level state s, where N is the
%       number of trials
%
% OUTPUTS:
